...
auth.settings.extra_fields['auth_user']=[
  Field('contact_no',requires=IS_NOT_EMPTY(error_message=auth.messages.is_empty)),
...
db.define_table('routes',Field('source_pt','string'),
                Field('destination_pt','string'),
                Field('dist_btw','double'),
                Field('traffic','double'))

db.define_table('share_cab_details',
                Field('user_id','string'),
                Field('source_pt','string'),
                Field('destination_pt','string'),
...
db.define_table('shared_cab_details',
                Field('travel_id','reference share_cab_details'),
                Field('user_id','string'),
                Field('source_pt','string'),
                Field('destination_pt','string'),
